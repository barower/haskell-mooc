...
stripify :: String -> String
stripify s = init (tail s)

palindromify :: String -> String
palindromify s = if isPalindrome s then s else palindromify (stripify s)
...
addEithers (Right a) (Left s)  = Left s
