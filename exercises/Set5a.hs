...
data UpDown = IncreasingMode Int | DecreasingMode Int

-- zero is an increasing counter with value 0
zero :: UpDown
zero = IncreasingMode 0

-- get returns the counter value
get :: UpDown -> Int
get (IncreasingMode a) = a
get (DecreasingMode a) = a

-- tick increases an increasing counter by one or decreases a
-- decreasing counter by one
tick :: UpDown -> UpDown
tick (IncreasingMode a) = IncreasingMode (a+1)
tick (DecreasingMode a) = DecreasingMode (a-1)

-- toggle changes an increasing counter into a decreasing counter and
-- vice versa
toggle :: UpDown -> UpDown
toggle (IncreasingMode a) = DecreasingMode a
toggle (DecreasingMode a) = IncreasingMode a
...
fromNat :: Nat -> Int
fromNat Zero = 0
fromNat (PlusOne next) = 1 + fromNat next
